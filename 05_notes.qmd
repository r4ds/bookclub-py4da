...
:::{.callout-note}
This is a long chapter, these notes are intended to highlight some concepts! 
:::
...
* Index by labels, sets of labels, boolean arrays ...
...
* Above a changed a column into an index.  Often you want to go the other way, this can be done with `reset_index`: 
