...
link-citations: yes
github-repo: r4ds/bookclub-py4da
description: "This is the product of the R4DS Online Learning Community's Python for Data Analysis Book Club."
---
...
This is a companion for the book [_Python for Data Analysis_](https://wesmckinney.com/book/) by Wes McKinney (O'Reilly Media, Inc., copyright 2022, [9781098104030](https://www.oreilly.com/library/view/python-for-data/9781098104023/)).
This companion is available at [r4ds.io/py4da](https://r4ds.io/py4da).
...
- More information about how to present is available in the [github repo](https://github.com/r4ds/bookclub-py4da).
